function More() {
    return (
      ...
      <div className="  ms-96  h-5/6 my-4 w-8/12 col-span-8 fixed   rounded-xl bg-white border:none  sm:px-8 ">
        ...
        <p className="py-2 text-xs font-semibold">Email Address</p>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <p className="text-gray-600 text-xs">
            Your email address is <strong>john.doe@company.com</strong>
          </p>
          <button className="inline-flex text-xs font-semibold text-green-600 underline decoration-2">
            Change
          </button>
        </div>
        <hr className="mt-4 mb-6" />
        <p className="py-2 text-xs font-semibold">Password</p>
        <div className="flex items-center">
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-3">
            <label htmlFor="login-password-current">
          ...
          <svg
            ...
            className="mt-5 ml-2 h-6 w-6 cursor-pointer text-xs font-semibold text-gray-600 underline decoration-2"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth="2"
        ...
        <p className="mt-2 text-xs">
          ...
          <a
            className="text-xs font-semibold text-purple-600 underline decoration-2"
            href="#"
          >
            Recover Account
          </a>
        </p>
        <button className="mt-4 rounded-lg text-xs bg-purple-600 px-4 py-2 text-white">
          Save Password
        </button>
        <hr className="mt-4 mb-4" />
  
        <div className="mb-6">
          <p className="py-2 text-xs font-semibold">Delete Account</p>
