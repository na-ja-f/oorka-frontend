...
function ViewPost({ post }) {
    ...
    return (
        <div className="bg-white overflow-hidden z-50 w-full shadow-none"
            style={{ width: "1000px" }}>
            ...
            <div className="col-span-1 relative pl-4">
                <header className="border-b border-grey-400">
                    <a href="#" className="block cursor-pointer py-4 items-center text-sm outline-none focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
