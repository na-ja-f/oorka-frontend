...
import { User2, LogOutIcon, LayoutDashboard, ShieldBan, Hash, MessageCircleWarning } from "lucide-react";
                ...
                <div className="bg-white pb-10 rounded-xl flex md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out">
                    <div className="space-y-2 md:space-y-4 mt-2">
                        ...
                        <div id="menu" className="flex flex-col  mt-4 space-y-2">
                            ...
                            <Link to="/admin/posts" className="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-myViolet hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
                            >
                                <ShieldBan className="inline-block" />
                                <span className="ml-2">Block Posts</span>
                            </Link>
